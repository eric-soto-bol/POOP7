...
public class POOP7 {
    ...
    public static void main(String[] args) {
        ...
        Animal animal = new Animal("León", 5, "Felino", 190.5f, "Sabana");
        System.out.println(animal);

        // Instanciar y trabajar con la clase Perro
        Perro perro = new Perro("Max", 3, "Canino", 30.0f, "Casa", "Labrador", "Marrón", false, 80, true);
        System.out.println(perro);
        perro.ladrar();
        perro.correr();

        // Instanciar y trabajar con la clase Aves
        Aves ave = new Aves("Águila", 4, "Ave", 6.5f, "Montañas", "Plumas largas", true, 2, "Marrón", 80);
        System.out.println(ave);
        ave.volar();
        ave.cantar();

        // Instanciar y trabajar con la clase Dalmata
        /*Dalmata dalmata = new Dalmata("Pongo", 5, "Canino", 30.0f, "Casa", "Dálmata", "Blanco con manchas negras", 101);
        System.out.println(dalmata);
        dalmata.mostrarManchas();*/

        // Instanciar y trabajar con la clase PastorAleman
        PastorAleman pastorAleman = new PastorAleman("Rex", 4, "Canino", 35.0f, "Policía", "Pastor Alemán", "Negro y Marrón", 95, "Guardia");
        ...
        Paloma paloma = new Paloma("Paloma Blanca", 3, "Ave", 0.5f, "Ciudad", "Plumas cortas", true, 1, "Blanca", 60, true, "París");
